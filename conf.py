...
BLOG_DESCRIPTION = "Este es el blog del proyecto Alkiller"
...
# Default is ''
CONTENT_FOOTER = 'Contenidos &copy; {date} <a href="mailto:{email}">{author}</a> - Powered by <a href="http://nikola.ralsina.com.ar">Nikola</a>'
